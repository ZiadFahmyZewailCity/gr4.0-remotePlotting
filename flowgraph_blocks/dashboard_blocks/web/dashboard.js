...
var ASM_CONSTS = {
 ...
 229664: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 229747: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 229816: () => { return window.innerWidth; },  
 229846: () => { return window.innerHeight; }
};
