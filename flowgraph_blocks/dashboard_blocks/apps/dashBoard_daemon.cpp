...
bool read_config_file(zmq::socket_t & flowgraphSocket, const std::string &config_file_path){
...
int main(){
    ...
    std::string web_root = "../dashboard_blocks/web/";
    ...
    dashBoard_server.set_port(8080);
    ...
    */
    ...
    data_aggregation.connect("tcp://localhost:5555");
    //Listen to everything being sent
