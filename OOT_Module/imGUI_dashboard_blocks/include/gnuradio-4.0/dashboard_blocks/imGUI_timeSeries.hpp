#ifndef GNURADIO_DASHBOARDBLOCKS_IMGUI_TIMESERIES_HPP
#define GNURADIO_DASHBOARDBLOCKS_IMGUI_TIMESERIES_HPP
...
namespace gr::dashboard_blocks {
    ...
    struct imGUI_timeSeries : gr::Block<imGUI_timeSeries<T>> {
        ...
        GR_MAKE_REFLECTABLE(imGUI_timeSeries, in, id, title, panel_name, x_axis_label, y_axis_label ,endpoint);
...
GR_REGISTER_BLOCK("gr::dashboard_blocks::imGUI_timeSeries", gr::dashboard_blocks::imGUI_timeSeries, [float])
